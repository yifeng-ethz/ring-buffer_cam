...
- compile the delivered `Default P4` configuration after the `26.1.9.0419` metadata alignment and the `2026-04-20` DV/dashboard refresh
...
5. `rtl/ring_buffer_cam.vhd` metadata defaults were aligned to `26.1.9.0419` / `20260419`, and `script/ring_buffer_cam_hw.tcl` now carries the same packaged META DATE default.
