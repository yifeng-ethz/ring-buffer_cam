...
- compile the delivered `Default P4` configuration after the `26.1.5.0417` RTL bug-fix refresh
...
5. `rtl/ring_buffer_cam.vhd` metadata defaults were aligned to `26.1.5.0417` so the wrapper identity matches the packaged release.
