...
namespace eval ::altera_lvds::core_20::main:: {
   ...
   variable top_level_mod_name "altera_lvds_core20"
}
...
proc ::altera_lvds::core_20::main::create_parameters {} {
   ...
   ::altera_iopll_common::iopll::init
    ...
    add_derived_hdl_param   USE_DIV_RECONFIG                    string              "false"
    ...
    if {[string_compare $mode "TX"]} { 
       ...
       if {[string_compare $mode "RX_DPA-FIFO"] || [string_compare $mode "RX_Soft-CDR"]} {   
            ...
            if {[param_string_compare ENABLE_DIV_RECONFIG "true"]} {
                set_interface_property user_mdio_dis_conduit_end ENABLED true
                set_interface_property user_dprio_clk_conduit_end ENABLED true
                set_interface_property user_dprio_rst_n_conduit_end ENABLED true
                set_interface_property user_dprio_read_conduit_end ENABLED true
                set_interface_property user_dprio_reg_addr_conduit_end ENABLED true
                set_interface_property user_dprio_write_conduit_end ENABLED true
                set_interface_property user_dprio_writedata_conduit_end ENABLED true

                set_interface_property user_dprio_block_select_conduit_end ENABLED true
                set_interface_property user_dprio_readdata_conduit_end ENABLED true
                set_interface_property user_dprio_ready_conduit_end ENABLED true
            }
...
proc ::altera_lvds::core_20::main::_update_qip {} {
    ...
    if {[param_string_compare USE_EXTERNAL_PLL "false"]} {
        if {![string equal $mode "RX_Soft-CDR"]} {
            if {[param_string_compare PLL_CORECLOCK_RESOURCE "Global"]} {
                lappend qip_strings "${set_inst_asgmnt} -name GLOBAL_SIGNAL \"GLOBAL CLOCK\" -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|outclock\[$coreclock_idx\]\""
                if {[string equal $mode "RX_DPA-FIFO"] || [string equal $mode "RX_Non-DPA"]} {
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 15 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 15 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 15 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 15 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[1\]\""
                } elseif {[string equal $mode "TX"] && [string equal $tx_register_clock "tx_coreclock"]} {
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 23 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 10 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 10 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 10 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_C_COUNTER_DELAY_CHAIN 10 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[1\]\""
                }
            } elseif {[param_string_compare PLL_CORECLOCK_RESOURCE "Periphery"] || [param_string_compare PLL_CORECLOCK_RESOURCE "Auto"]}  {
                lappend qip_strings "${set_inst_asgmnt} -name GLOBAL_SIGNAL \"PERIPHERY CLOCK\" -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|outclock\[$coreclock_idx\]\""
                if {[string equal $mode "TX"] && [string equal $tx_register_clock "tx_coreclock"]} {
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 12 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 12 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[0\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 12 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|loaden\[1\]\""
                    lappend qip_strings "${set_inst_asgmnt} -name PLL_LVDS_DELAY_CHAIN 12 -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|lvds_clk\[1\]\""
                }
            }
        }
        
        if {[param_string_compare ENABLE_DIV_RECONFIG "true"]} {
            lappend qip_strings "${set_inst_asgmnt} -name GLOBAL_SIGNAL \"GLOBAL CLOCK\" -to \"altera_lvds_core20:arch_inst|altera_lvds_core20_pll:internal_pll.pll_inst|outclock\[3\]\""
        }
    }
...
proc ::altera_lvds::core_20::main::sim_vhdl_fileset_callback {top_level} {
    ...
    ::altera_lvds::util::hwtcl_utils::generate_vhdl_sim $top_level $top_level_mod_name [list altera_lvds_core20.sv altera_lvds_core20_pll.v]
}
...
proc ::altera_lvds::core_20::main::sim_verilog_fileset_callback {top_level} {
    ...
    set file_paths [concat [::altera_emif::util::hwtcl_utils::generate_top_level_sv_wrapper $top_level $top_level_mod_name] \
                           altera_lvds_core20.sv \
                           altera_lvds_core20_pll.v ]
...
proc ::altera_lvds::core_20::main::get_wysiwyg_silicon_rev_string {} {
...
proc ::altera_lvds::core_20::main::_create_all_interfaces_disabled {} {
    ...
    add_if ext_dprio_clk conduit end INPUT
    ...
    add_if user_mdio_dis           conduit end INPUT
    add_if user_dprio_rst_n        conduit end INPUT
    add_if user_dprio_read         conduit end INPUT
    add_if user_dprio_reg_addr     conduit end INPUT 9
    add_if user_dprio_write        conduit end INPUT
    add_if user_dprio_writedata    conduit end INPUT 8
    
    add_if user_dprio_clk          conduit end OUTPUT
    add_if user_dprio_block_select conduit end OUTPUT
    add_if user_dprio_readdata     conduit end OUTPUT 8
    add_if user_dprio_ready        conduit end OUTPUT
}
...
proc ::altera_lvds::core_20::main::_elaborate_external_pll_interfaces {} {
    ...
    if {[param_string_compare ENABLE_DIV_RECONFIG "true"]} {
        set_interface_property ext_dprio_clk_conduit_end ENABLED true
    }
}
...
proc ::altera_lvds::core_20::main::_set_derived_hdl_parameters {} {
    ...
    if {[get_parameter_value ENABLE_DIV_RECONFIG]} {
        set_parameter_value USE_DIV_RECONFIG "true"
    } else {
        set_parameter_value USE_DIV_RECONFIG "false"
    }
}
