...
#
# $Id: //depot/users/rcalvi/tclxml-3.2/pkgIndex.tcl#2 $

#######################################################
# NOTE: THIS FILE HAS BEEN MODIFIED BY ALTERA TO
#       ADDRESS CASE:20380. SEE BELOW.
#######################################################
...
#######################################################
# BEGIN ALTERA CHANGES
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#
# CASE:20380 -
#      Replaced $dir with {$dir} inside strings to fix
#      a bug that occurs when paths contain spaces
#
#######################################################
