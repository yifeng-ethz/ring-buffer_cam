...
module feb_system_v3_pipe_lvdsctrl_control_path_subsystem_mm_interconnect_0_router_002_default_decode
  #(
...
module feb_system_v3_pipe_lvdsctrl_control_path_subsystem_mm_interconnect_0_router_002
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    feb_system_v3_pipe_lvdsctrl_control_path_subsystem_mm_interconnect_0_router_002_default_decode the_default_decode(
    ...
    // ( 0x4c4 .. 0x4c8 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 19'h4c4  && write_transaction  ) begin
