...
- SC enable mask: `n/a`
- Expected JDI hash: `79B277D5ED4F37C0C382`
- Live design hash: `79B277D5ED4F37C0C382`
- Result: `PASS`
...
2) USB-BlasterII [7-2]
  02A020DD   5AGT(FC7H3|MC7G3)/5AGXBA7D4/..
    ...
    Design hash    79B277D5ED4F37C0C382
```
...
- Return code: `0`
```
crw-rw-rw- 1 root users 10, 124 Apr 24 23:36 /dev/mudaq0
```

## Image Check

- Status: `PASS`
- Detail: live 79B277D5ED4F37C0C382 matches JDI 79B277D5ED4F37C0C382
