...
DEFAULT_RTL_LATENCY = Path(
    "firmware_builds/systems/system_20260427_testplanphase5/model/phase4/inputs/"
...
DEFAULT_BOARD_REPORT = Path(
    "firmware_builds/systems/system_20260427_testplanphase5/model/phase4/inputs/board/"
...
def main() -> int:
    ...
    ap.add_argument(
        "--artifact-dir",
        type=Path,
        default=Path("firmware_builds/systems/system_20260427_testplanphase5/model/phase4/artifacts"),
    )
