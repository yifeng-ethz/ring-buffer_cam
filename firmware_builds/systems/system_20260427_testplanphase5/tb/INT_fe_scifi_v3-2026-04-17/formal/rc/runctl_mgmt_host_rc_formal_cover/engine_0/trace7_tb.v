...
`endif
    ...
    UUT.dut.recv_payload32 = 32'b00010011101110000000000000000100;
    UUT.dut.recv_payload_cnt = 4'b0100;
    UUT.dut.recv_payload_len = 4'b0100;
    UUT.dut.recv_reset_assert_mask = 16'b0000000000000000;
    UUT.dut.recv_reset_release_mask = 16'b0000000000000000;
    UUT.dut.recv_run_command = 8'b00010000;
    UUT.dut.recv_run_number = 32'b00000000000000000000000000000000;
    UUT.dut.recv_state = 8'b00000001;
    UUT.dut.recv_state_sync_q0 = 8'b00000001;
    ...
    UUT.noack_cmd = 8'b00010010;
    UUT.stim_kind = 3'b001;
    UUT.error_code = 3'b100;
    UUT.kchar_byte = 8'b00111100;
    UUT.prepare_run_number = 32'b00010011101110000000000000000100;
