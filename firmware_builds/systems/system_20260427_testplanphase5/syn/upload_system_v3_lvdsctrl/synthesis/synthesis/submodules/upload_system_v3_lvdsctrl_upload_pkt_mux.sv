...
//   output_name:        upload_system_v3_lvdsctrl_upload_pkt_mux
//   use_packets:        true
//   use_empty:          0
//   empty_width:        0
//   data_width:         36
...
module upload_system_v3_lvdsctrl_upload_pkt_mux (     
// Interface: out
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   upload_system_v3_lvdsctrl_upload_pkt_mux_1stage_pipeline  #( .PAYLOAD_WIDTH( 38 + 2 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module upload_system_v3_lvdsctrl_upload_pkt_mux_1stage_pipeline
