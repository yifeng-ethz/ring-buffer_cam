...
module scifi_datapath_system_v3_mm_interconnect_1_router_default_decode
  #(
...
module scifi_datapath_system_v3_mm_interconnect_1_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    scifi_datapath_system_v3_mm_interconnect_1_router_default_decode the_default_decode(
