...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/feb_system_v3_pipe_bringup_subsystem_irq_mapper.sv"                             -work irq_mapper            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/feb_system_v3_pipe_bringup_subsystem_mm_interconnect_0.v"                       -work mm_interconnect_0     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/feb_system_v3_pipe_bringup_subsystem_sysid.v"                                   -work sysid                 
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/feb_system_v3_pipe_bringup_subsystem_cpu.v"                                     -work cpu                   
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/feb_system_v3_pipe_mm_interconnect_1.v"                                         -work mm_interconnect_1     
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/feb_system_v3_pipe_mm_interconnect_0.v"                                         -work mm_interconnect_0     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_reset_controller.v"                                                      -work control_reset_sync_125
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_reset_synchronizer.v"                                                    -work control_reset_sync_125
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L irq_mapper -L mm_interconnect_0 -L timer_ts -L timer -L sysid -L si_out -L si_in -L ram -L jtag_uart -L dbg0 -L cpu -L avalon_st_adapter_002 -L avalon_st_adapter_001 -L avalon_st_adapter -L mm_interconnect_1 -L upload_subsystem -L data_path_subsystem -L control_reset_sync_125 -L control_path_subsystem -L bringup_subsystem -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
