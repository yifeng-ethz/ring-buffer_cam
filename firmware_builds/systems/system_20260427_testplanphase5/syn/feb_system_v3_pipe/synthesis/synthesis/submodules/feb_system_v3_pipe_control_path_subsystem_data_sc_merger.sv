...
//   output_name:        feb_system_v3_pipe_control_path_subsystem_data_sc_merger
//   use_packets:        true
//   use_empty:          0
//   empty_width:        0
//   data_width:         36
...
module feb_system_v3_pipe_control_path_subsystem_data_sc_merger (     
// Interface: out
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   feb_system_v3_pipe_control_path_subsystem_data_sc_merger_1stage_pipeline  #( .PAYLOAD_WIDTH( 38 + 1 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module feb_system_v3_pipe_control_path_subsystem_data_sc_merger_1stage_pipeline
