...
//   output_name:        feb_system_v3_pipe_lvdsctrl_upload_subsystem_upload_pkt_mux
//   use_packets:        true
//   use_empty:          0
//   empty_width:        0
//   data_width:         36
...
//   inPayloadMap:       in0_data,in0_startofpacket,in0_endofpacket in1_data,in1_startofpacket,in1_endofpacket in2_data,in2_startofpacket,in2_endofpacket
...
module feb_system_v3_pipe_lvdsctrl_upload_subsystem_upload_pkt_mux (     
// Interface: out
...
/*AUTOARG*/);
   ...
   //| Signal Declarations
   // ---------------------------------------------------------------------
   reg [38 -1:0]      in0_payload;
   reg [38 -1:0]      in1_payload;
   reg [38 -1:0]      in2_payload;
   ...
   wire               out_valid_wire;
   wire               selected_ready;
   reg   [38 -1 :0]   selected_payload;  
   reg                packet_in_progress;
   wire [2-1:0]       out_select;   
   wire [38 - 1:0]    out_payload;
   ...
   always @* begin
     ...
     in2_payload = {in2_data,in2_startofpacket,in2_endofpacket};
   end
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   feb_system_v3_pipe_lvdsctrl_upload_subsystem_upload_pkt_mux_1stage_pipeline  #( .PAYLOAD_WIDTH( 38 + 2 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module feb_system_v3_pipe_lvdsctrl_upload_subsystem_upload_pkt_mux_1stage_pipeline
