...
module feb_system_v3_pipe_lvdsctrl_data_path_subsystem_mm_interconnect_0_router_default_decode
  #(
...
module feb_system_v3_pipe_lvdsctrl_data_path_subsystem_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD31 = log2ceil(64'hac10 - 64'hac00); 
    localparam PAD32 = log2ceil(64'hb080 - 64'hb000); 
    localparam PAD33 = log2ceil(64'hb100 - 64'hb080); 
    localparam PAD34 = log2ceil(64'hb180 - 64'hb100); 
    localparam PAD35 = log2ceil(64'hb200 - 64'hb180); 
    localparam PAD36 = log2ceil(64'hb240 - 64'hb200); 
    localparam PAD37 = log2ceil(64'hb480 - 64'hb400); 
    localparam PAD38 = log2ceil(64'hb500 - 64'hb480); 
    localparam PAD39 = log2ceil(64'hb580 - 64'hb500); 
    localparam PAD40 = log2ceil(64'hb600 - 64'hb580); 
    localparam PAD41 = log2ceil(64'hd040 - 64'hd000); 
    localparam PAD42 = log2ceil(64'hd080 - 64'hd040); 
    // -------------------------------------------------------
    ...
    feb_system_v3_pipe_lvdsctrl_data_path_subsystem_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0xac00 .. 0xac10 )
    if ( {address[RG:PAD31],{PAD31{1'b0}}} == 16'hac00   ) begin
