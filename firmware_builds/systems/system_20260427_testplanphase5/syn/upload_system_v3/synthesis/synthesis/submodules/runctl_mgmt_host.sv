...
// Version : 26.2.5
// Date    : 20260424
// Change  : 26.2.5 — accept reset-protocol link-test and sync-test opcodes
...
module runctl_mgmt_host #(
    ...
    parameter logic [3:0]  VERSION_PATCH  = 4'd5,
    parameter logic [11:0] BUILD          = 12'h424,     // MMDD = 0424
    parameter logic [31:0] VERSION_DATE   = 32'h2026_0424,
