...
-- ============================================================
-- File Name: ip_altiobuf_bidir.vhd
-- Megafunction Name(s):
-- 			altiobuf_bidir
--
...
--synthesis_resources = arriav_io_ibuf 1 arriav_io_obuf 1 
 ...
 ENTITY  ip_altiobuf_bidir_iobuf_bidir_nho IS 
	 PORT 
	 ( 
 ...
 END ip_altiobuf_bidir_iobuf_bidir_nho;

 ARCHITECTURE RTL OF ip_altiobuf_bidir_iobuf_bidir_nho IS
 ...
 END RTL; --ip_altiobuf_bidir_iobuf_bidir_nho
--VALID FILE
...
END ip_altiobuf_bidir;


ARCHITECTURE RTL OF ip_altiobuf_bidir IS

	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (0 DOWNTO 0);



	COMPONENT ip_altiobuf_bidir_iobuf_bidir_nho
	PORT (
			datain	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
			oe	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
			dataout	: OUT STD_LOGIC_VECTOR (0 DOWNTO 0);
...
BEGIN
	...
	ip_altiobuf_bidir_iobuf_bidir_nho_component : ip_altiobuf_bidir_iobuf_bidir_nho
	PORT MAP (
		datain => datain,
		oe => oe,
		dataout => sub_wire0,
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altiobuf_bidir.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altiobuf_bidir.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altiobuf_bidir.cmp FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altiobuf_bidir.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altiobuf_bidir_inst.vhd FALSE
