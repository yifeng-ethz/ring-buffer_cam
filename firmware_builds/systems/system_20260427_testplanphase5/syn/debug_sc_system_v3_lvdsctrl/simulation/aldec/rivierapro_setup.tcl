...
# ACDS 18.1 625 linux 2026.04.23.13:02:11
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     debug_sc_system_v3_lvdsctrl
# 
...
# ----------------------------------------
# If debug_sc_system_v3_lvdsctrl is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "debug_sc_system_v3_lvdsctrl"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/debug_sc_system_v3_lvdsctrl.v"
}
