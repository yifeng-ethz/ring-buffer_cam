...
//   output_name:        debug_sc_system_v3_lvdsctrl_data_sc_merger
//   use_packets:        true
//   use_empty:          0
//   empty_width:        0
//   data_width:         36
...
module debug_sc_system_v3_lvdsctrl_data_sc_merger (     
// Interface: out
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   debug_sc_system_v3_lvdsctrl_data_sc_merger_1stage_pipeline  #( .PAYLOAD_WIDTH( 38 + 1 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module debug_sc_system_v3_lvdsctrl_data_sc_merger_1stage_pipeline
