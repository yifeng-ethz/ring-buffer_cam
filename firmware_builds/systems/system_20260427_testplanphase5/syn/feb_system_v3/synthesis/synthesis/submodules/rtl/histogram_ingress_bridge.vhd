...
-- Revision: 26.0.1
--     Date: 20260421
--     Change: Add a tap-only post-input mode so a CDC-copied post-hit-stack
--             stream can share one histogram selector without stalling the
--             primary upload/export path.
-- =========
-- Description:
...
entity histogram_ingress_bridge is
    ...
    port (
        ...
        asi_pre_empty    : in  std_logic_vector(0 downto 0);
        asi_pre_error    : in  std_logic_vector(0 downto 0);
        ...
        aso_pre_empty    : out std_logic_vector(0 downto 0);
        aso_pre_error    : out std_logic_vector(0 downto 0);
...
begin
    ...
    aso_hist_valid    <= asi_pre_valid when csr_select_post_live = '0' else asi_post_valid;
    aso_hist_data    <= asi_pre_data when csr_select_post_live = '0' else hist_post_data;
    aso_hist_startofpacket <= asi_pre_startofpacket when csr_select_post_live = '0' else asi_post_startofpacket;
    aso_hist_endofpacket    <= asi_pre_endofpacket when csr_select_post_live = '0' else asi_post_endofpacket;
    ...
    begin
        ...
        post_hist_ready    <= aso_hist_ready or not csr_select_post_live;
    ...
    begin
        ...
        post_hist_ready    <= '1' when csr_select_post_live = '0' else aso_hist_ready;
