...
// Version : 26.2.1
// Date    : 20260422
// Change  : 26.2.1 — require a trained synclink K-idle/comma before accepting
...
module runctl_mgmt_host #(
    ...
    parameter logic [11:0] BUILD          = 12'h422,     // MMDD = 0422
    parameter logic [31:0] VERSION_DATE   = 32'h2026_0422,
