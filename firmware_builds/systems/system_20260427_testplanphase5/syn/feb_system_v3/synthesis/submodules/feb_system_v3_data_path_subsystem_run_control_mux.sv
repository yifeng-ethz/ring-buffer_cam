...
//   output_name:        feb_system_v3_data_path_subsystem_run_control_mux
//   use_packets:        false
//   use_empty:          0
//   empty_width:        0
//   data_width:         9
...
module feb_system_v3_data_path_subsystem_run_control_mux (     
// Interface: out
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   feb_system_v3_data_path_subsystem_run_control_mux_1stage_pipeline  #( .PAYLOAD_WIDTH( 9 + 1 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module feb_system_v3_data_path_subsystem_run_control_mux_1stage_pipeline
