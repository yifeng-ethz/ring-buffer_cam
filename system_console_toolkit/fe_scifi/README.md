...
- `/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/system_console_toolkit/fe_scifi`

Compatibility path consumed by the FE SciFi project:

- `/home/yifeng/packages/online_dpv2/online/mu3e-ip-cores/system_console_toolkit/fe_scifi`
...
- `/home/yifeng/packages/online_dpv2/online/mu3e-ip-cores/system_console_toolkit -> /home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/system_console_toolkit`

Do not add new toolkit edits under the deprecated snapshot tree
`/home/yifeng/packages/online_dpv2/online/mu3e-ip-cores/system_console_toolkits/`.
...
- `board_bring_up/debug/board_bring_up_cli_probe.tcl`: CLI-only inventory probe. Example:
  `system-console --script=/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/system_console_toolkit/fe_scifi/board_bring_up/debug/board_bring_up_cli_probe.tcl`
