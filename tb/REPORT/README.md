...
|:---:|---|---:|---:|---|
| ⚠️ | [`BASIC`](buckets/BASIC.md) | 129 | 90 | stmt=97.28, branch=89.15, cond=73.39, expr=40.00, fsm_state=100.00, fsm_trans=66.67, toggle=71.46 |
| ⚠️ | [`EDGE`](buckets/EDGE.md) | 129 | 20 | stmt=95.56, branch=84.81, cond=69.35, expr=40.00, fsm_state=100.00, fsm_trans=66.67, toggle=67.10 |
...
- evidenced_cases = `137`
- excluded_cases = `0`
- merged total code coverage: `stmt=97.33, branch=89.33, cond=73.39, expr=40.00, fsm_state=100.00, fsm_trans=66.67, toggle=72.86`
