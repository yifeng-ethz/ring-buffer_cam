...
|:---:|---|---:|---:|---|
| ⚠️ | [`BASIC`](buckets/BASIC.md) | 129 | 120 | stmt=96.67, branch=87.57, cond=70.23, expr=40.00, fsm_state=100.00, fsm_trans=66.67, toggle=71.85 |
...
| ⚠️ | [`ERROR`](buckets/ERROR.md) | 129 | 36 | stmt=94.40, branch=83.00, cond=67.74, expr=30.00, fsm_state=100.00, fsm_trans=66.67, toggle=44.84 |
...
- evidenced_cases = `189`
- excluded_cases = `0`
- merged total code coverage: `stmt=97.02, branch=88.11, cond=70.99, expr=40.00, fsm_state=100.00, fsm_trans=66.67, toggle=73.07`
