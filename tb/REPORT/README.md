...
| ⚠️ | [`ERROR`](buckets/ERROR.md) | 129 | 41 | stmt=94.40, branch=83.00, cond=67.74, expr=30.00, fsm_state=100.00, fsm_trans=66.67, toggle=44.98 |
...
- evidenced_cases = `194`
- excluded_cases = `0`
- merged total code coverage: `stmt=97.02, branch=88.11, cond=72.52, expr=40.00, fsm_state=100.00, fsm_trans=66.67, toggle=73.15`
