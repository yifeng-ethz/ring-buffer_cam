...
set_module_property VERSION 26.2.1.0421
set_module_property DESCRIPTION "Ring-buffer shaped content-addressable memory for timestamp ordering. This delivered release keeps the current Qsys interface contract, fixes the low-stage partitioned-encoder build safety issue, wraps the live write pointer at the configured ring depth for non-power-of-two builds, and refreshes the supporting variant/depth evidence."
...
add_html_text "Delivered Profile" profile_html "<html><b>Catalog revision</b><br/>This release is packaged as <b>26.2.1.0421</b>. It keeps the established <b>hit_type1</b>, <b>hit_type2</b>, <b>run_control</b>, and <b>filllevel</b> interface names so existing Platform Designer systems can be upgraded in place while picking up the common CSR identity header, the locked <b>BUILD=421</b> / <b>VERSION_DATE=20260421</b> metadata, the low-stage partitioned-encoder build safety repair, the non-power-of-two ring-depth write-pointer wrap, and the refreshed evidence through the active-build variant/depth screens <b>P050(pipe1)</b>, <b>P050(pipe2)</b>, and <b>P050(n768)</b>.<br/><br/><b>Runtime visibility</b><br/>Software can blind-scan the CSR window through <b>UID</b> at word <b>0</b> and the <b>META</b> mux at word <b>1</b>.</html>"
