...
set_module_property VERSION 26.2.3.0421
...
add_html_text "Delivered Profile" profile_html "<html><b>Catalog revision</b><br/>This release is packaged as <b>26.2.3.0421</b>. It keeps the established <b>hit_type1</b>, <b>hit_type2</b>, <b>run_control</b>, and <b>filllevel</b> interface names so existing Platform Designer systems can be upgraded in place while picking up the common CSR identity header, the locked <b>BUILD=421</b> / <b>VERSION_DATE=20260421</b> metadata, the earlier low-stage partitioned-encoder and non-power-of-two ring-depth repairs, the new push-write erase-slot carry that closes the tightened standalone <b>137.5 MHz</b> signoff clock, and the refreshed evidence through <b>B134(n768)</b>, <b>P111</b>, and the clean standalone <b>P4</b> compile.<br/><br/><b>Runtime visibility</b><br/>Software can blind-scan the CSR window through <b>UID</b> at word <b>0</b> and the <b>META</b> mux at word <b>1</b>.</html>"
