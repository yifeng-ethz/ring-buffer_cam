...
set_module_property VERSION 26.2.2.0421
set_module_property DESCRIPTION "Ring-buffer shaped content-addressable memory for timestamp ordering. This delivered release keeps the current Qsys interface contract, preserves the earlier non-power-of-two pointer-wrap repair, adds the wrap-overwrite erase-address fix for non-power-of-two builds, and refreshes the supporting variant/depth evidence."
...
add_html_text "Delivered Profile" profile_html "<html><b>Catalog revision</b><br/>This release is packaged as <b>26.2.2.0421</b>. It keeps the established <b>hit_type1</b>, <b>hit_type2</b>, <b>run_control</b>, and <b>filllevel</b> interface names so existing Platform Designer systems can be upgraded in place while picking up the common CSR identity header, the locked <b>BUILD=421</b> / <b>VERSION_DATE=20260421</b> metadata, the earlier low-stage partitioned-encoder and non-power-of-two write-pointer repairs, the new non-power-of-two wrap-overwrite erase-address fix, and the refreshed evidence through <b>B134(n768)</b> plus <b>P126(n768, DV_LONG_TXN_OVERRIDE=4000)</b>.<br/><br/><b>Runtime visibility</b><br/>Software can blind-scan the CSR window through <b>UID</b> at word <b>0</b> and the <b>META</b> mux at word <b>1</b>.</html>"
